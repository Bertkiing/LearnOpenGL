...
public class ScreenRotateUtil {
    ...
    public OrientationsListener mOrientationsListener;

    public interface OrientationsListener {
        void getOrientation(int orientation);
    }

    public OrientationsListener getOrientationsListener() {
        return mOrientationsListener;
    }

    public void setOrientationsListener(OrientationsListener orientationsListener) {
        mOrientationsListener = orientationsListener;
    }
    ...
    private Handler mHandler = new Handler(Looper.getMainLooper()) {
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 888) {
                ...
                LogUtil.d(TAG, "===========" + orientation);
                /**
                 * 根据手机屏幕的朝向角度，来设置内容的横竖屏，并且记录状态
                 */
                if (orientation > 45 && orientation < 135) {
                    if (mOrientationsListener != null) {
                        mOrientationsListener.getOrientation(1);
                    }
//                    mActivity.setRequestedOrientation(ActivityInfo.SCREEN_ORIENTATION_REVERSE_LANDSCAPE);
                    isLandscape = true;
                } else if (orientation > 135 && orientation < 225) {
                    if (mOrientationsListener != null) {
                        mOrientationsListener.getOrientation(2);
                    }
